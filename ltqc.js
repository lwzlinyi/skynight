...
class UserInfo {
    constructor(str) {
        ...
        this.ck = str.split('&')[0];
        this.host = "clientapi.dsmp.voyah.com.cn";
        this.hostname = "https://" + this.host;
        this.ckstatus = true
        this.headersGet = {
            //txcookie: this.ck1,
            deviceSN: '70e81c32746832ca',
            Host: 'clientapi.dsmp.voyah.com.cn',
            platform: 'android',
            version:2.9.0,
            systemVersion:33,
            deviceType:realme RMX3562,
            osversion:Android13,
            Content-Length:0,
    ...
    */
    ...
    async task_sign() { // 执行签到
        try {
            const options = {
                url: 'https://clientapi.dsmp.voyah.com.cn/v1/vip/makeUpSign/date',
                headers: this.headersPostv1,
                body: ``,
            };
            //console.log(options);
